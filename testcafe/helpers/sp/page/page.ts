...
class SPPage {
    ...
    public async addSection(p: number, layout: pageLayout) {
        await t
            .click(
                Selector('button').withAttribute('data-automation-id', 'toolboxHint-zone').nth(p),
    ...
    public async editSection(s: number) {
        ...
        await t.click(
            Selector('div')
                .withAttribute('data-automation-id', 'CanvasZoneToolbar')
                .find('button')
    ...
    public async removeSection(s: number) {
        ...
        await t.click(
            Selector('div')
                .withAttribute('data-automation-id', 'CanvasZoneToolbar')
                .find('button')
                .withAttribute('data-automation-id', 'removeButton'),
            { offsetX: 10, offsetY: 10 }
        );
    }
    ...
    public async addWebPart(wp: number, title: string) {
        ...
        // Click on web part
        await t.click(
            Selector('div').withAttribute('data-automation-id', 'less-text').withText(title)
        );
    }
